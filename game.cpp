...
#define X_DIMENSION 27
#define Y_DIMENSION 27
#define ROOM_SIZE 9
#define DOOR_SIZE 3
...
*/
	...
	cout << "This game has one simple objective: get out." << endl;
			sleep_for(milliseconds(60));
			cout << endl;
	cout << "In this game, you're stuck in a house which contains " << (X_ROOMS * Y_ROOMS) << " \nrooms, of which you have to navigate to eventually find the exit." << endl;
			sleep_for(milliseconds(60));
	cout << "One of the bordering rooms will have an exit attached, which you can use to leave \nthe house and complete the game." << endl;
			sleep_for(milliseconds(60));
			cout << endl;
	cout << "There are two items placed in each room, making a total of " << 2*(X_ROOMS * Y_ROOMS) << " items, \none of which is required to exit the house. It's up to you to find which one is needed to exit." << endl;
			sleep_for(milliseconds(60));
	cout << "You begin with a phone in your inventory, which you can trade for any of \nthe items found in the rooms." << endl;
			sleep_for(milliseconds(60));
			cout << endl;
	cout << "You'll also have 3 attempts to guess a specific random number, which if you \nguess correctly, will immediately allow you to exit the house." << endl;
			sleep_for(milliseconds(60));
	cout << "However, should you happen to guess another certain number, you'll lose the \nability to move, stranding you and ultimately ending your game right then and there." << endl;
			sleep_for(milliseconds(60));
	cout << "So, be careful when utilizing this option!" << endl;
			sleep_for(milliseconds(60));
			cout << endl;
	cout << "In short, in order to exit the house, you must aquire the correct object and \nthen proceed to find the exit attached to the outside of one of the bordering rooms (not displayed on provided map)." << endl; 
			sleep_for(milliseconds(60));
	cout << "At the end, you will recieve a certificate containing, among other things, a \ngrade based upon the number of moves it took you to exit, so be mindful of how many times you move rooms! " << endl;
	cout << "*****************************************************************************************************************************************************************************" << endl;
